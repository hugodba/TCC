...
\paragraph{} Para validar a implementação, utilizou-se como referência a instância RC201 de Solomon (resultado e procedimentos seguidos para alcançar tal, respectivamente em \cite{Sintef100, Mester05}). A figura abaixo apresenta a distribuição espacial dos clientes nesta instância.
