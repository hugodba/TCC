...
\paragraph{} Cabe registrar que, em termos absolutos, as soluções permanecem distantes das melhores soluções conhecidas. A comparação aqui conduzida é relativa entre os métodos implementados, e não frente ao estado da arte de solvers de VRPTW.
